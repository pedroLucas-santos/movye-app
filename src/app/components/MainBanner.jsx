...
import { fetchMoviePoster, options, fetchMovieBackdrop } from "../lib/movieApi"
...
const MainBanner = () => {
    ...
    useEffect(() => {
        const fetchPoster = async () => {
            try {
                const url = await fetchMoviePoster(options)
                setPosterUrl(url)
            } catch (e) {
                console.error(e)
            }
        ...
        const fetchBackdrop = async () => {
            try {
                const response = await fetchMovieBackdrop(options)
        ...
        <div className={`relative w-full h-[720px] bg-cover shadow-inner shadow-gray-900/80`} style={{ backgroundImage: backdrop ? `url(${backdrop})` : "" }}>
            ...
            <div className="relative z-10 flex flex-col items-center">
                ...
                <div className="border-2 border-dashed border-indigo-500 w-full h-[500px] mt-8 flex justify-evenly items-center">
                    ...
                    <div className="border-2 border-dashed border-indigo-700 w-[300px] h-[450px]">

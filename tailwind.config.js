...
module.exports = {
  content: [
    ...
    "./node_modules/@heroui/theme/dist/components/(drawer|dropdown|listbox|modal|progress|select|skeleton|toggle|popover|menu|divider|button|ripple|spinner|form|scroll-shadow).js"
  ],
  theme: {
    extend: {
      colors: {

...
module.exports = {
  content: [
    ...
    "./node_modules/@heroui/theme/dist/components/(avatar|card|drawer|dropdown|listbox|modal|progress|select|skeleton|toggle|popover|ripple|menu|divider|button|spinner|form|scroll-shadow).js"
  ],
  theme: {
    extend: {
      colors: {
